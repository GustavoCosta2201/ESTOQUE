...
constraint FK_PRODUTO_ITEM_COMPRA FOREIGN KEY(ID_COMPRA) REFERENCES PRODUTO(ID_PRODUTO) ON DELETE CASCADE);

/*CRIA A TABELA CONTAS A PAGAR*/
CREATE TABLE CONTAS_PAGAR(
ID_SEQUENCIA    INTEGER NOT NULL,
ID_COMPRA       INTEGER NOT NULL,
VL_PARCELA      DECIMAL(11,2) NOT NULL,
...
/*CRIA A TABELA CONTAS A RECEBER*/
